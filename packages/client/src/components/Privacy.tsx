export function Privacy() {
  return (
    <div className="p-4 whitespace-pre-wrap">
      {`
Open Recommender Privacy Policy.
Last updated: 17/01/2024

This Privacy Policy describes how Open Recommender (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from https://open-recommender.com (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
...
- Order information including your name, payment confirmation, email address, phone number.
- Account information including your username, password, security questions.
- Content viewing information including videos and articles you have watched, liked, disliked, and shared.
...
The Services may enable you to post user-generated content. If you choose to submit user generated content to any public area of the Services, this content will be public and accessible by anyone.
...
Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at experimentallearning0@gmail.com.

For the purpose of applicable data protection laws, we are the data controller of your personal information. Our representative in the EEA and the UK is James Baghurst, who can be contacted at experimentallearning0@gmail.com.
  `}
    </div>
  );
}
